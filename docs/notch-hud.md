...
**Tunables** (shared constants in `src/shared/notch-hud.ts`, main constants in
...
vertical-offset clamp), `NOTCH_BAR_RATIO` (0.03, notch-detection threshold as a fraction of
